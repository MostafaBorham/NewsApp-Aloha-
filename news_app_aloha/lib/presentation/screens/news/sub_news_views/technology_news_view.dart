...
class TechnologyNewsView extends StatelessWidget {
  const TechnologyNewsView({super.key});
  @override
  Widget build(BuildContext context) {
    return BlocProvider<NewsBloc>(
      create: (context) => AppInjector.instance<NewsBloc>()
        ..add(GetAllNewsEvent(newsType: NewsCategories.technology)),
          ...
          return RefreshIndicator(
            ...
            child: ConditionalBuilder(
              ...
              builder: (context) => ConditionalBuilder(
                condition:
                    NewsBloc.getInstance(context).technologyNewsList.isNotEmpty,
                builder: (context) {
                  return NewsList(
                    newsList: NewsBloc.getInstance(context).technologyNewsList,
                  );
                },
